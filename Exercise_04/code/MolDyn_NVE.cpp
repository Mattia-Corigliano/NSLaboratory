...
int main(){ 
  ...
  int nconf = 1, measurement_step=5, measurements=nstep/measurement_step, nblocks=20, i=0, j=0, measurements_per_block = measurements/nblocks;
...
void Input(void){ //Prepare all stuff for the simulation
  ...
  ReadInput.open("input.txt"); //Read input
...
//Read initial configuration
  cout << "Read initial configuration from file config.in " << endl;
  if(improved_mode==true) cout << "Read initial configuration from file config_old.txt" << endl;
  ReadConf.open("config.in");
  ReadConf2.open("config_old.txt");
